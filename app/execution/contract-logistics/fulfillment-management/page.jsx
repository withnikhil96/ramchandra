  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 pt-16">
                ...
                <div className="lg:order-1 text-center lg:text-left space-y-6">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">
                      Efficient Fulfillment, Seamless Service Your Logistics
                      Partner for Streamlined Operations
                    </h3>
                    <div className="w-20 h-1 bg-blue-600 mx-auto lg:mx-0"></div>
                  </div>
                  <div className="space-y-6 text-lg md:text-xl leading-relaxed">
                    <p className="text-pretty">
                      A fulfillment-center serves as the cornerstone of modern
        ...
        {/* Benefits of Fulfillment Centers Section */}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center">
                  ...
                  <p className="text-muted-foreground">
                    Data-driven insights and analytics for informed
