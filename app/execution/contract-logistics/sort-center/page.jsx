...
export default function SortCenter() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 pt-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                ...
                <div className="lg:order-1 text-center lg:text-left space-y-6">
                  <div className="space-y-4">
                    ...
                    Efficiency Sorted, Speed Delivered Your Go-To Sort-Center for Streamlined Operations
                    </h3>
                    <div className="w-20 h-1 bg-blue-600 mx-auto lg:mx-0"></div>
                  </div>
                  <div className="space-y-6 text-lg md:text-xl leading-relaxed">
                    <p className="text-pretty">
                    In the complex web of supply chain operations, a sort center stands as a pivotal facility meticulously engineered to orchestrate the seamless sorting and consolidation of incoming shipments. Acting as a strategic nerve center, it assumes the responsibility of receiving diverse shipments from various origins, subsequently subjecting them to a rigorous sorting process based on predefined criteria such as destination, urgency of delivery, or specific customer requirements. 
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* Benefits of Sort Centers Section */}
        <section className="py-20 md:py-32 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="text-center space-y-4 mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-800">
                  Benefits of Sort Centers
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center">
                  ...
                  <p className="text-muted-foreground">
                    Streamlined internal processes and optimized material flow
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center">
                  ...
                  <p className="text-muted-foreground">
                    Optimized material handling and distribution processes
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center">
                  ...
                  <p className="text-muted-foreground">
                    Enhanced responsiveness to market demands through flexible
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center">
                  ...
                  <p className="text-muted-foreground">
                  Advanced automation and software systems for efficient sorting and tracking decision-making and continuous improvement.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center">
                  ...
                  <p className="text-muted-foreground">
                    Improved customer satisfaction through reliable and
                    efficient in-plant logistics services.
                  </p>
                </div>
              </div>
            </div>
